...
(function(window) {
  ...
  Gauge.prototype.drawTriangle = function (beginX, beginY) {
    ...
    context.lineTo(-beginX + this.triangle_height, -beginY);
    context.fill();
    context.restore();
  };
  Gauge.prototype.drawCenterNum = function () {
    ...
    var centerText = Math.ceil(this._percent * ((this.total_tick - 1) * this.num_gap + this.num_begin)/100)
    context.fillText(centerText, 0, -this.tick_length);
    context.restore();
  }
